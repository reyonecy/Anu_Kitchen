  ...
  return (
    <div>
      <div className="bg-[url('/images/home.png')] w-full h-screen bg-center bg-cover gap-2 flex flex-col justify-center items-center">
          ...
          <button className="bg-[#FF9E0B] hover:bg-[#FF9E0B] hover:bg-opacity-50 hover:font-medium hover:tracking-wide px-4 py-2 rounded-md mt-6 text-white transition duration-300 ease-in-out">MENU</button>
